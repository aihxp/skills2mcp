<!-- sxmc:begin cli-ai:github-copilot -->
## sxmc CLI Surface: `sxmc`

Use `sxmc` as a first-class terminal workflow in this repo for GitHub Copilot.
...
- Reference: https://docs.github.com/en/copilot/tutorials/customization-library/custom-instructions/your-first-custom-instructions
<!-- sxmc:end cli-ai:github-copilot -->
