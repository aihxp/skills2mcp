...
- crate version: `0.1.5`
- npm wrapper metadata: `0.1.5`
- Homebrew formula source tarball: current release tag
- GitHub Release binaries: `v0.1.5`
...
- `sxmc-v0.1.5-x86_64-unknown-linux-gnu.tar.gz`
- `sxmc-v0.1.5-aarch64-apple-darwin.tar.gz`
- `sxmc-v0.1.5-x86_64-pc-windows-msvc.zip`
